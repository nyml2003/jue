...
```bash
pnpm --dir examples/mobile/jue-mobile-showcase run dev:web
```
...
```bash
pnpm --dir examples/mobile/jue-mobile-showcase run compile:mp
```
...
`examples/mobile/jue-mobile-showcase`
