...
const workspaceAliases = {
  ...
  "@jue/runtime-core/channel": resolve(__dirname, "packages/runtime-core/src/channel.ts"),
  ...
  "@jue/primitives": resolve(__dirname, "packages/primitives/src/index.ts"),
  "@jue/authoring-check": resolve(__dirname, "packages/authoring-check/src/index.ts"),
  "@jue/stream": resolve(__dirname, "packages/stream/src/index.ts"),
  "@jue/router": resolve(__dirname, "packages/router/src/index.ts"),
  "@jue/query": resolve(__dirname, "packages/query/src/index.ts"),
  "@jue/devtrace": resolve(__dirname, "packages/devtrace/src/index.ts"),
  "@jue/docsgen": resolve(__dirname, "packages/docsgen/src/index.ts"),
